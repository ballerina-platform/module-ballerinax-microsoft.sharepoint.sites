# Ballerina Microsoft SharePoint Sites Connector connector
...
The `Microsoft SharePoint Sites Connector` connector provides practical examples illustrating usage in various scenarios. Explore these [examples](https://github.com/module-ballerinax-microsoft.sharepoint.sites/tree/main/examples/), covering the following use cases:
